...
const NavbarSmallDevice = ({openMenu, setOpenMenu}) => {
    return (
      <div
        className={`w-full h-screen fixed top-0 left-0 bg-primary-soft ${
      ...
      >
        ...
        <nav className="flex flex-col items-center space-y-3 justify-center mt-15">
          <NavLink to="/" className="hover:text-accent text-lg">
            Home
          </NavLink>
          <NavLink to="/all-issues" className="hover:text-accent text-lg">
            All Issues
          </NavLink>
          <NavLink to="/about" className="hover:text-accent text-lg">
            About Us
          </NavLink>
          <NavLink to="/contact" className="hover:text-accent text-lg">
            Contact
          </NavLink>
        </nav>
      </div>
